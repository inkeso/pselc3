...
app = pselc3_gtk.Pselect({
    ...
    # see https://events.ccc.de/congress/2013/Fahrplan/events.html
    "murl" : "https://events.ccc.de/congress/2013/Fahrplan/events/%s.html",
    ...
    "base" : "http://cdn.media.ccc.de/congress/2013/mp4/",
    #"base" : "http://mirror.fem-net.de/CCC/30C3/mp4/",

    # match filenames, group for ID, Language and Name and complete filename within index-HTML
    "rex" : r'<a href="30c3-([0-9]{4})-(de-en|en|de)-(.+?)_h264-hq.mp4">(30c3-.+?-hq.mp4)</a>'
})
